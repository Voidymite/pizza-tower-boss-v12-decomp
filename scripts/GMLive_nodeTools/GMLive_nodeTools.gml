...
function gml_node_tools_is_in_block(l_q,l_p){
	...
	switch(l__g.__enumIndex__){
		case 95:return true;
		case 96:if(l_q!=l__g.h_then)return l_q==l__g.h_not; else return true;
		case 101:return l_q==l__g.h_loop;
		case 103:return l_q==l__g.h_loop;
		case 102:return l_q==l__g.h_loop;
		case 104:return l_q==l__g.h_loop;
		case 105:return (l_q==l__g.h_pre||l_q==l__g.h_post)||l_q==l__g.h_loop;
		case 98:
...
function gml_node_tools_to_case_value(l_q){
	...
	switch(l__g.__enumIndex__){
		case 2:
			...
			return l_f;
		case 3:return l__g.h_value;
		case 5:return l__g.h_ctr.h_value;
...
function gml_node_tools_seek_all(l_q,l_st,l_c,l_pg){
	...
	var l__g=l_q;
	switch(l__g.__enumIndex__){
		case 10:l_r=l_c(l__g.h_obj,undefined);break;
		case 21:l_r=l_c(l__g.h_index,undefined);break;
		case 33:l_r=l_c(l__g.h_expr,undefined);break;
		case 34:l_r=l_c(l__g.h_expr,undefined);break;
		case 38:l_r=l_c(l__g.h_expr,undefined);break;
		...
		case 48:l_r=l_c(l__g.h_val,undefined);break;
		...
		case 54:l_r=l_c(l__g.h_val,undefined);break;
		case 59:l_r=l_c(l__g.h_val,undefined);break;
		case 60:l_r=l_c(l__g.h_val,undefined);break;
		case 99:l_r=l_c(l__g.h_time,undefined);break;
		case 107:l_r=l_c(l__g.h_loop,undefined);break;
		case 108:l_r=l_c(l__g.h_val,undefined);break;
		case 114:l_r=l_c(l__g.h_err,undefined);break;
		case 0:l_r=false;break;
		case 1:l_r=false;break;
		case 2:l_r=false;break;
		case 3:l_r=false;break;
		case 4:l_r=false;break;
		case 5:l_r=false;break;
		...
		case 20:l_r=false;break;
		case 22:l_r=false;break;
		case 32:l_r=false;break;
		case 43:l_r=false;break;
		case 46:l_r=false;break;
		case 49:l_r=false;break;
		case 52:l_r=false;break;
		case 58:l_r=false;break;
		case 100:l_r=false;break;
		...
		case 36:
			...
			break;
		case 6:gml_node_tools_seek_arr(l__g.h_values,l_c,l_st);break;
		case 7:gml_node_tools_seek_arr(l__g.h_values,l_c,l_st);break;
		case 94:
			var l_v=l__g.h_val;
			l_r=l_v!=undefined&&l_c(l_v,undefined);
			break;
		case 39:l_r=l_c(l__g.h_a,undefined);break;
		case 35:l_r=l_c(l__g.h_expr,undefined);break;
		case 95:l_r=gml_node_tools_seek_arr(l__g.h_nodes,l_c,l_st);break;
		case 23:l_r=gml_node_tools_seek_1or_arr(l__g.h_expr,l__g.h_args,l_c,l_st);break;
		case 26:l_r=gml_node_tools_seek_1or_arr(l__g.h_index,l__g.h_args,l_c,l_st);break;
		case 31:l_r=gml_node_tools_seek_1or_arr(l__g.h_ctr,l__g.h_args,l_c,l_st);break;
		case 25:l_r=gml_node_tools_seek_1or_arr(l__g.h_inst,l__g.h_args,l_c,l_st);break;
		case 28:l_r=gml_node_tools_seek_1or_arr(l__g.h_obj,l__g.h_args,l_c,l_st);break;
		case 30:l_r=gml_node_tools_seek_1or_arr(l__g.h_expr,l__g.h_args,l_c,l_st);break;
		case 24:l_r=gml_node_tools_seek_arr(l__g.h_args,l_c,l_st);break;
		case 29:l_r=gml_node_tools_seek_arr(l__g.h_args,l_c,l_st);break;
		case 27:
		...
		case 97:
			...
			break;
		case 105:l_r=gml_node_tools_seek_or2(l__g.h_pre,l__g.h_cond,l_c,undefined);break;
		case 101:l_r=l_c(l__g.h_cond,undefined);break;
		case 106:l_r=l_c(l__g.h_ctx,undefined);break;
		case 103:l_r=l_c(l__g.h_loop,undefined);break;
		case 102:l_r=l_c(l__g.h_loop,undefined);break;
		case 104:l_r=l_c(l__g.h_times,undefined);break;
		case 98:
		...
		case 113:
			...
			break;
		case 37:l_r=gml_node_tools_seek_or2(l__g.h_a,l__g.h_b,l_c,l_st);break;
		case 42:l_r=gml_node_tools_seek_or2(l__g.h_fd,l__g.h_obj,l_c,l_st);break;
		case 64:l_r=l_c(l__g.h_index,undefined);break;
		case 65:l_r=gml_node_tools_seek_or2(l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 66:l_r=gml_node_tools_seek_or2(l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 67:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_index,l_c,l_st);break;
		case 68:l_r=gml_node_tools_seek_or3(l__g.h_obj,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 69:l_r=gml_node_tools_seek_or3(l__g.h_obj,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 11:l_r=gml_node_tools_seek_or2(l__g.h_arr,l__g.h_ind,l_c,l_st);break;
		case 12:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_ind1,l__g.h_ind2,l_c,l_st);break;
		case 70:l_r=gml_node_tools_seek_or2(l__g.h_arr,l__g.h_index,l_c,l_st);break;
		case 71:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 72:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 73:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index1,l__g.h_index2,l_c,l_st);break;
		case 74:l_r=gml_node_tools_seek_or4(l__g.h_arr,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 75:l_r=gml_node_tools_seek_or4(l__g.h_arr,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 76:l_r=gml_node_tools_seek_or2(l__g.h_arr,l__g.h_index,l_c,l_st);break;
		case 77:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 78:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 79:l_r=gml_node_tools_seek_or3(l__g.h_arr,l__g.h_index1,l__g.h_index2,l_c,l_st);break;
		case 80:l_r=gml_node_tools_seek_or4(l__g.h_arr,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 81:l_r=gml_node_tools_seek_or4(l__g.h_arr,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 55:l_r=l_c(l__g.h_obj,undefined);break;
		case 56:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_val,l_c,l_st);break;
		case 57:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_val,l_c,l_st);break;
		case 61:l_r=l_c(l__g.h_obj,undefined);break;
		case 62:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_val,l_c,l_st);break;
		case 63:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_val,l_c,l_st);break;
		case 82:l_r=gml_node_tools_seek_or2(l__g.h_list,l__g.h_index,l_c,l_st);break;
		case 83:l_r=gml_node_tools_seek_or3(l__g.h_list,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 84:l_r=gml_node_tools_seek_or3(l__g.h_list,l__g.h_index,l__g.h_val,l_c,l_st);break;
		case 85:l_r=gml_node_tools_seek_or2(l__g.h_map,l__g.h_key,l_c,l_st);break;
		case 86:l_r=gml_node_tools_seek_or3(l__g.h_map,l__g.h_key,l__g.h_val,l_c,l_st);break;
		case 87:l_r=gml_node_tools_seek_or3(l__g.h_map,l__g.h_key,l__g.h_val,l_c,l_st);break;
		case 88:l_r=gml_node_tools_seek_or3(l__g.h_grid,l__g.h_index1,l__g.h_index2,l_c,l_st);break;
		case 89:l_r=gml_node_tools_seek_or4(l__g.h_grid,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 90:l_r=gml_node_tools_seek_or4(l__g.h_grid,l__g.h_index1,l__g.h_index2,l__g.h_val,l_c,l_st);break;
		case 91:l_r=gml_node_tools_seek_or2(l__g.h_obj,l__g.h_key,l_c,l_st);break;
		case 92:l_r=gml_node_tools_seek_or3(l__g.h_obj,l__g.h_key,l__g.h_val,l_c,l_st);break;
		case 93:l_r=gml_node_tools_seek_or3(l__g.h_obj,l__g.h_key,l__g.h_val,l_c,l_st);break;
	}
