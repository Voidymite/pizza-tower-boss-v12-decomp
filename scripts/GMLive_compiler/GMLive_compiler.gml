...
function gml_compile_const_val_of(l_q){
	...
	switch(l__g.__enumIndex__){
		...
		case 4:l_tmp=l__g.h_value;break;
		case 19:l_tmp=gml_const_val[$ l__g.h_name];break;
...
function gml_compile_node(l_q,l_actions,l_out){
	...
	var l__g=l_q;
	switch(l__g.__enumIndex__){
		case 8:ds_list_add(l_actions,gml_action_ensure_array_for_local(l__g.h_d,gml_compile_curr_script.h_local_map[$ l__g.h_name]));break;
		case 9:ds_list_add(l_actions,gml_action_ensure_array_for_global(l__g.h_d,l__g.h_name));break;
		case 10:
		...
		case 42:
			...
			break;
		case 49:ds_list_add(l_actions,gml_action_global_hx(l__g.h_d,l__g.h_name));break;
		case 50:
		...
		case 55:
			...
			switch(l__g1.__enumIndex__){
				case 14:if(l_fastGetter!=undefined)ds_list_add(l_actions,gml_action_fast_self_field(l__g.h_d,l_fastGetter)); else ds_list_add(l_actions,gml_action_self_field(l__g.h_d,l_s));break;
				case 43:
					var l_i1=gml_compile_curr_script.h_local_map[$ l__g1.h_name];
		...
		case 69:
			...
			break;
		case 58:ds_list_add(l_actions,gml_action_env(l__g.h_d,l__g.h_v.h_func));break;
		case 59:
			var l_av=l__g.h_v;
			if(gml_compile_node(l__g.h_val,l_actions,true))return true;
		...
		case 66:
			...
			break;
		case 20:ds_list_add(l_actions,gml_action_arg_const(l__g.h_d,l__g.h_index));break;
		case 21:
			if(gml_compile_node(l__g.h_index,l_actions,true))return true;
			ds_list_add(l_actions,gml_action_arg_index(l__g.h_d));
			break;
		case 22:ds_list_add(l_actions,gml_action_arg_count(l__g.h_d));break;
		case 37:
			l_d=l__g.h_d;
			l_o=l__g.h_op;
			l_x=l__g.h_a;
			...
			break;
		case 36:return compile_gml_compile_bin_op_proc(l_actions,l__g.h_d,l__g.h_op,l__g.h_a,l__g.h_b);
		case 35:
			if(gml_compile_node(l__g.h_expr,l_actions,true))return true;
			ds_list_add(l_actions,gml_action_un_op(l__g.h_d,l__g.h_op));
			break;
		case 33:return compile_gml_compile_adjfix_proc(l__g.h_d,l__g.h_expr,true,l__g.h_inc,l_actions,l_out);
		case 34:return compile_gml_compile_adjfix_proc(l__g.h_d,l__g.h_expr,false,l__g.h_inc,l_actions,l_out);
		case 24:
			l_d=l__g.h_d;
			l_w=l__g.h_args;
			...
			ds_list_add(l_actions,gml_action_call_script(l_d,gml_compile_curr_program.h_script_map[$ l__g.h_name],l_n));
		...
		case 29:return compile_gml_compile_call_func_proc(l_actions,l__g.h_d,l__g.h_func,l__g.h_args,l_out);
		case 32:ds_list_add(l_actions,gml_action_func_literal(l__g.h_d,l__g.h_name));break;
		case 95:
			l_w=l__g.h_nodes;
			l_n=array_length(l_w);
			if(l_n>0){
		...
		case 99:
			...
			break;
		case 38:if(compile_gml_compile_delete_proc(l_actions,l__g.h_d,l__g.h_expr))return true;break;
		case 100:ds_list_add(l_actions,gml_action_fork(l__g.h_d,l_out));break;
