...
if(live_enabled)
/// @implements {gml_node}
function mc_gml_node_static_hx():mc_gml_node()constructor{
	/// @hint {ast_GmlNodeData} :h_d
	/// @hint {string} :h_name
	static __enumParams__=["h_d","h_name"];
...
if(live_enabled)
function gml_node_static_hx(l_h_d,l_h_name){
	var l_this=new mc_gml_node_static_hx();
	l_this.h_d=l_h_d;
	l_this.h_name=l_h_name;
	return l_this
}
...
function mc_gml_node_static_set():mc_gml_node()constructor{
	...
	/// @hint {ast_GmlNode} :h_val
	/// @hint {bool} :h_isInit
	static __enumParams__=["h_d","h_name","h_val","h_isInit"];
	static __enumIndex__=47;
}

if(live_enabled)
function gml_node_static_set(l_h_d,l_h_name,l_h_val,l_h_isInit){
	var l_this=new mc_gml_node_static_set();
	l_this.h_d=l_h_d;
	l_this.h_name=l_h_name;
	l_this.h_val=l_h_val;
	l_this.h_isInit=l_h_isInit;
	return l_this
}
...
if(live_enabled)
/// @implements {gml_node}
function mc_gml_node_script_static():mc_gml_node()constructor{
	/// @hint {ast_GmlNodeData} :h_d
	/// @hint {string} :h_scr
	/// @hint {string} :h_name
	static __enumParams__=["h_d","h_scr","h_name"];
	static __enumIndex__=52;
}

if(live_enabled)
function gml_node_script_static(l_h_d,l_h_scr,l_h_name){
	var l_this=new mc_gml_node_script_static();
	l_this.h_d=l_h_d;
	l_this.h_scr=l_h_scr;
	l_this.h_name=l_h_name;
	return l_this
}
...
if(live_enabled)
/// @implements {gml_node}
function mc_gml_node_script_static_set():mc_gml_node()constructor{
	/// @hint {ast_GmlNodeData} :h_d
	/// @hint {string} :h_scr
	/// @hint {string} :h_name
	/// @hint {ast_GmlNode} :h_val
	static __enumParams__=["h_d","h_scr","h_name","h_val"];
	static __enumIndex__=53;
}

if(live_enabled)
function gml_node_script_static_set(l_h_d,l_h_scr,l_h_name,l_h_val){
	var l_this=new mc_gml_node_script_static_set();
	l_this.h_d=l_h_d;
	l_this.h_scr=l_h_scr;
	l_this.h_name=l_h_name;
	l_this.h_val=l_h_val;
...
if(live_enabled)
/// @implements {gml_node}
function mc_gml_node_script_static_aop():mc_gml_node()constructor{
	/// @hint {ast_GmlNodeData} :h_d
	/// @hint {string} :h_scr
	/// @hint {string} :h_name
	/// @hint {gml_op} :h_op
	/// @hint {ast_GmlNode} :h_val
	static __enumParams__=["h_d","h_scr","h_name","h_op","h_val"];
	static __enumIndex__=54;
}

if(live_enabled)
function gml_node_script_static_aop(l_h_d,l_h_scr,l_h_name,l_h_op,l_h_val){
	var l_this=new mc_gml_node_script_static_aop();
	l_this.h_d=l_h_d;
	l_this.h_scr=l_h_scr;
	l_this.h_name=l_h_name;
	l_this.h_op=l_h_op;
