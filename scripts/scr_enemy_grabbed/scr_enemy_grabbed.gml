function scr_enemy_grabbed()
{
	if (grabbedby == 1)
	{
	    ...
	    with (obj_player1)
	    {
	        ...
	        if (!((state == states.grab || state == states.finishingblow || state == states.grabbing || state == states.throw || state == states.slam || state == states.tacklecharge || state == states.punch || state == states.superslam || state == states.backkick || state == states.uppunch || state == states.shoulder)))
	        {
	            other.x = x
	            other.y = y
	    ...
	    if (obj_player1.state == states.throw)
	    {
	        global.hit += 1
	        if (other.object_index == obj_pizzaball)
	            global.golfhit += 1
	...
	if (grabbedby == 2)
	{
	    ...
	    if (obj_player2.state == states.throw)
	    {
	        global.hit += 1
	        if (other.object_index == obj_pizzaball)
	            global.golfhit += 1
