scr_music(); // sets some variables 
if ((!audio_is_playing(panicmusicID)) && (!audio_is_playing(mu_noiseescape)) && string_letters(roomname) != "dragonlair" && global.panic == 1 && obj_pause.pause == 0 && obj_camera.ded == 0)
{
    audio_stop_all();
	scr_sound(panicmusicID);
	pausedmusic = panicmusicID;
}
